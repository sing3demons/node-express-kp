...
exports.ServerKafka = exports.ServerKafkaError = void 0;
...
exports.ServerKafkaError = ServerKafkaError;
class ServerKafka {
    constructor(options) {
        this.client = null;
        this.consumer = null;
        ...
        this.validate = (topic, data, rawMessage) => {
            ...
            if (schema === null || schema === void 0 ? void 0 : schema.body) {
                const typeCheck = compiler_1.TypeCompiler.Compile(schema.body);
            ...
            if (schema === null || schema === void 0 ? void 0 : schema.headers) {
                const typeCheck = compiler_1.TypeCompiler.Compile(schema.headers);
